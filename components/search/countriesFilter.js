...
const CountriesFilter = () => {
    // const countryy =useSelector(state=>state.channel.filter.country)
    const [countryy,setCountry]=useState('AllCountries')
            ...
            return (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  padding: '0 10px',
                  background: countryy == country ? '#9595ff' : 'white',
                  color: countryy == country ? 'white' : 'black',
              ...
              >
                ...
                :null}
               {country=='AllCountries' ? translations[language].channelsS.allCountries : country}
                {/* <CountryFlag countryCode={country} svg />  */}
              </div>
            );
          })}
