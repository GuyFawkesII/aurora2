...
`
const ChannelItem = React.memo(function ChannelItem({ name,country }) {
    return (
      <div
        style={{
          color: 'black',
      ...
      >
                ...
                {country=='ASIA' ?
                  ...
                  :null}
                {country!='ASIA' && country!='AllCountries' && country!='All' ?
...
// import { fetchFilteredChannels, setChannelFilter } from '../../store/actions';
...
//   //   if (activeCountry) {
//   //     filtered = filtered.filter((channel) => channel.country === activeCountry);
//   //   }
//   //   if (searchTerm) {
//   //     const searchRegex = new RegExp(searchTerm, 'i');
//   //     filtered = filtered.filter((channel) => searchRegex.test(channel.name));
//   //   }
//   //   return filtered;
//   // }, [activeCountry, searchTerm]);

//   // const countries = channels ? [...new Set(channels.map((channel) => channel.country))]: [];
//   // console.log(countries)
//   const channels = useSelector(state=>state.channel.filtered)
...
//               alignItems: 'center',
//               padding: '0 10px',
//               background: activeCountry == null ? '#9595ff' : 'white',
//               color: activeCountry == null ? 'white' : 'black',
//             }}
//             onClick={() => handleCountryFilter(null)}
//           >
//             {translations[language].channelsS.allCountries}
//           </div>
...
//                   alignItems: 'center',
//                   padding: '0 10px',
//                   background: activeCountry == country ? '#9595ff' : 'white',
//                   color: activeCountry == country ? 'white' : 'black',
//                   display: country == 'All' ? 'none' : 'flex',
//                 }}
//                 onClick={() => handleCountryClick(country)}
//               >
//                 <CountryFlag countryCode={country} svg /> {country}
//               </div>
//             );
//           })}
//         </div>
