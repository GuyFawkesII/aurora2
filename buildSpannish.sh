...
NEXT_PUBLIC_TAG_MANAGER=GTM-53H5FP2Q
NEXT_PUBLIC_ANALYTICS=G-2Q4RBD6K36
...
sshpass -p "94RMsY@xlvwS@vz1" scp /root/aurora/next.zip root@49.12.106.222:/var/www/vhosts/aurorarapido.com/httpdocs

# Use sshpass to execute the command with password input
sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "rm -rf /var/www/vhosts/aurorarapido.com/httpdocs/.next"

# Use sshpass to execute the unzip command with password input
sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "unzip -o /var/www/vhosts/aurorarapido.com/httpdocs/next.zip -d /var/www/vhosts/aurorarapido.com/httpdocs/"
sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "touch /var/www/vhosts/aurorarapido.com/httpdocs/tmp/restart.txt"
