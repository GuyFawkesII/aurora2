...
NEXT_PUBLIC_TAG_MANAGER=GTM-NGH5DKFP
NEXT_PUBLIC_ANALYTICS=G-7V4Q2R7VPJ
...
sshpass -p "94RMsY@xlvwS@vz1" scp next.zip root@49.12.106.222:/var/www/vhosts/iptvaurora.com/httpdocs

# Use sshpass to execute the command with password input
sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "rm -rf /var/www/vhosts/iptvaurora.com/httpdocs/.next"

# Use sshpass to execute the unzip command with password input
sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "unzip -o /var/www/vhosts/iptvaurora.com/httpdocs/next.zip -d /var/www/vhosts/iptvaurora.com/httpdocs/"

# Additional commands can be added here if needed



sshpass -p "94RMsY@xlvwS@vz1" ssh root@49.12.106.222 "touch /var/www/vhosts/iptvaurora.com/httpdocs/tmp/restart.txt"
